...
export const Product = () => (
  ...
  >
    ...
    <div className="flex-grow p-6">
      ...
      <div className="text-xl font-medium text-gray-500">{number(110)}</div>
      <div
        className={clsx("w-full text-sm font-medium mt-2", "text-green-500")}
      >
        In stock
      </div>
      <div className="text-sm text-gray-400 overflow-ellipsis overflow-hidden truncate ...">
        ...
        Nostrum aperiam officiis aut reprehenderit illo.
      </div>
    </div>
